...
<head>
    ...
    <title>Criação do Sistema Mercado</title>
...
<body>
    ...
    <header class="hero text-center">
        <div class="container">
            <h1>Criação do Sistema Mercado</h1>
            <p>Escolha os campos que deseja implementar no seu sistema de mercado para gerenciamento de produtos e estoque.</p>
        </div>
    </header>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card form-card">
                    <h2 class="text-center mb-4">Selecione os Campos para Cadastro de Produtos</h2>
                    <p class="form-description">Escolha os campos que deseja adicionar ao seu sistema de cadastro de produtos no mercado.</p>
                    <form action="processa_criacao_mercado.php" method="post" id="form-campos">
                        <div class="scroll-container" id="campo-lista-mercado">
                            <!-- Campos de Mercado serão mostrados aqui como checkboxes -->
                        </div>
                        <button type="submit" class="btn btn-custom">Criar Sistema de Mercado</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <!-- Script customizado -->
    <script src="../scripts/script_mercado.js"></script>
